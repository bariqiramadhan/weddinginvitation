...
<head>
	...
	<!-- Fav and touch icons -->
	<link rel="icon" href="{$base_url}images/fav_touch_icons/favicon.ico" sizes="any">
	<link rel="icon" href="{$base_url}images/fav_touch_icons/favicon.svg" type="image/svg+xml">
	<link rel="apple-touch-icon" href="{$base_url}images/fav_touch_icons/apple-touch-icon-180x180.png">
	<link rel="manifest" href="{$base_url}images/fav_touch_icons/manifest.json">
	...
	<!-- Neela Icon Set CSS -->
	<link href="{$base_url}assets/css/neela-icon-set.css" rel="stylesheet" />
			...
			<div class="container">
				<div class="row about-elems-wrapper">
					<div class="element col-md-6 col-xl-4 offset-xl-2" data-animation-direction="from-left"
						...
						<div class="image">
							<img src="{$base_url}images/groom.jpg" alt="" width="600" height="714" />
					...
					<div class="element col-md-6 col-xl-4" data-animation-direction="from-right" data-animation-delay="400">
						<div class="image">
							<img src="{$base_url}images/bride.jpg" alt="" width="600" height="714" />
							<div class="hover-info neela-style">
								<div class="content">
				...
				<div class="row">
					<div class="about-us-desc col-lg-8 offset-lg-2" data-animation-direction="from-bottom"
						...
						<p>Today and always, beyond tomorrow, I need you beside me, always as my best friend, lover and forever soul
							...
							Vestibulum sit amet est nisl. Vestibulum iaculis finibus sem nec condimentum. Quisque nulla orci, aliquet
						...
						<img src="{$base_url}images/signature.png" alt="Anja & Sani">
					</div>
				</div>
			</div>
		</section>
							...
							<div class="info-wrapper" data-animation-direction="from-bottom" data-animation-delay="100">
								<div class="location-info">
									<div class="neela-style">
										...
										<h5>Financial Hall, Jakarta</h5>
										<p>Jl. Jenderal Sudirman No.Kav 58, <br>Jakarta Selatan</p>

										<div class="info-map-divider"></div>

										<h4 class="has-icon"><i class="icon-champagne-glasses"></i>Reception<small>05:30pm</small></h4>
										<h5>Ballroom Financial Hall, 2nd Floor</h5>
										<p>Jl. Jenderal Sudirman No.Kav 58, <br>Jakarta Selatan</p>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-md-8 col-xl-6">
						...
						<div class="section-desc">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In varius ante libero,
							...
							lobortis ut velit. Nam interdum hendrerit nisl et malesuada.</div>
					</div>
				</div>
						...
						<ul class="wedding-gifts">
							...
							<li id="gift-list" data-animation-direction="from-bottom" data-animation-delay="300">
								<div class="neela-style">
									...
									<div class="info">
										<a href="#" class="img"><img src="{$base_url}images/macys-logo.png" alt="Macy's" /></a>
										<a href="#" class="img"><img src="{$base_url}images/bed-bath-beyond-logo.png" alt="Target" /></a>
									</div>
								</div>
							</li>
					...
					<ul>
						<li>
							<div class="hover-info">
								<a class="btn btn-light btn-sm only-icon" href="{$base_url}images/wedding-gallery-1.jpg" data-lightbox="WeddingPhotos"
									title="Wedding Photos">
									<i class="fa fa-link"></i>
								</a>
							</div>
							<img src="{$base_url}images/wedding-gallery-1.jpg" alt="" width="380" height="380" />
						</li>

						<li>
							<div class="hover-info">
								<a class="btn btn-light btn-sm only-icon" href="{$base_url}images/wedding-gallery-4.jpg" data-lightbox="WeddingPhotos"
									title="Wedding Photos">
									<i class="fa fa-link"></i>
								</a>
							</div>
							<img src="{$base_url}images/wedding-gallery-4.jpg" alt="" width="380" height="380" />
						</li>

						<li>
							<div class="hover-info">
								<a class="btn btn-light btn-sm only-icon" href="{$base_url}images/wedding-gallery-3.jpg" data-lightbox="WeddingPhotos"
									title="Wedding Photos">
									<i class="fa fa-link"></i>
								</a>
							</div>
							<img src="{$base_url}images/wedding-gallery-3.jpg" alt="" width="380" height="380" />
						</li>
						...
						<li>
							...
							<img src="{$base_url}images/wedding-gallery-6.jpg" alt="" width="380" height="380" />
						</li>
					</ul>
					<ul>
						<li>
							<div class="hover-info">
								<a class="btn btn-light btn-sm only-icon" href="{$base_url}images/wedding-gallery-5.jpg" data-lightbox="WeddingPhotos"
									title="Wedding Photos">
									<i class="fa fa-link"></i>
								</a>
							</div>
							<img src="{$base_url}images/wedding-gallery-10.jpg" alt="" width="380" height="380" />
						</li>

						<li>
							<div class="hover-info">
								<a class="btn btn-light btn-sm only-icon" href="{$base_url}images/wedding-gallery-6.jpg" data-lightbox="WeddingPhotos"
									title="Wedding Photos">
									<i class="fa fa-link"></i>
								</a>
							</div>
							<img src="{$base_url}images/wedding-gallery-2.jpg" alt="" width="380" height="380" />
						</li>

						<li>
							<div class="hover-info">
								<a class="btn btn-light btn-sm only-icon" href="{$base_url}images/wedding-gallery-7.jpg" data-lightbox="WeddingPhotos"
									title="Wedding Photos">
									<i class="fa fa-link"></i>
								</a>
							</div>
							<img src="{$base_url}images/wedding-gallery-7.jpg" alt="" width="380" height="380" />
						</li>

						<li>
							<div class="hover-info">
								<a class="btn btn-light btn-sm only-icon" href="{$base_url}images/wedding-gallery-8.jpg" data-lightbox="WeddingPhotos"
									title="Wedding Photos">
									<i class="fa fa-link"></i>
								</a>
							</div>
							<img src="{$base_url}images/wedding-gallery-8.jpg" alt="" width="380" height="380" />
						</li>
					</ul>
				</div>
			</div>
